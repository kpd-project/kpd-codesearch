...
export function AddRepoDialog({ open, onOpenChange, onAdd, basePath = '' }: AddRepoDialogProps) {
                ...
                <div className="space-y-6 mt-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            {basePath && <span className="text-muted-foreground text-sm shrink-0">{basePath}/</span>}
                            <Input
                                id="repo-path"
                                value={path}
